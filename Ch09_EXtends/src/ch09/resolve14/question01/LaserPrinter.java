...
public class LaserPrinter extends Printer {
	...
	public LaserPrinter(String modelNmae, String manufacurer, P_INTERFACE pInterface, int printCount,
			int paperRemains, double tonnerRemainders) {
		super(modelNmae, manufacurer, pInterface, printCount, paperRemains);
